...
<body>
    <form id="setHomeForm" method="post">
    	<input type="hidden" name="deviceUserId" value="${security.deviceUserId }">
	    <table class="form">
	    	<tr>
	    		<td><label for="title">标题</label></td>
	    		<td>
	    			<input class="easyui-textbox" name="title" data-options="required:true,validType:'length[1,50]'" value="${security.title == null?'家':security.title}" style="width:300px">
	    		</td>
	    	</tr>
			<tr>
				<td>经度</td>
	    	...
	    	<tr>
	    		<td><label for="aliasName">范围</label></td>
	    		<td style="padding: 20px;"><input class="easyui-slider" name="radius" value="${security.radius}" style="width:300px;"
