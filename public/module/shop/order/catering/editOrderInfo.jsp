...
<form id="frmOrder" method="post">
    ...
    <input type="hidden" id="sendIntegral" name="sendIntegral" />
...
<!--            </tr> -->
        ...
        <tr>
            <td>用餐人数</td>
            <td colspan="3" class="form"><input class="easyui-numberbox" name="mealNumber" value=1 data-options="min:1,precision:0,required:true"  style="width: 50px;"></td>
        </tr>
        <tr>
            <td>订单备注</td>
            <td>
