	...
	<table id="dgOrder" class="easyui-datagrid" toolbar='#tbrDgOrder'>
	    <thead>
	        <tr>
	            ...
	            <th data-options="field:'paymentFee',width:70,halign:'center', align:'center', formatter: UICommon.datagrid.formatter.integer">积分</th>
...
<script src="${modulePath}shop/order/order.manager.js?v=1"></script>
</body>
</html>