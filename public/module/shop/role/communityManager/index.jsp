...
<div data-options="region:'center',split:true,collapsible:true" style="height:40%;">
	<%@ include file="../../pro/dgPro.jsp" %>
</div>
<div data-options="region:'south',title:'店铺员工',split:true,collapsible:true" style="height:30%;">
