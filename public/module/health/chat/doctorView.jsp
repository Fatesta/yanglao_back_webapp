    ...
    <div class="right">
        ...
        <div class="center">
            <div class="left">
                <div class="top">
                    <div class="title">
                        <div class="left-title">
                            <span id="videoTitle" style="display:none">您正在与<span id="videoOtherSideName" class="name2" style="color:#5FB0CD;"></span>进行视频咨询</span>
                            <span id="msg"></span>
                        </div>
                    </div>
                    <div class="shiping">
                ...
                <div class="zdyj" >
                    <div class="zdyj-title">医生意见</div>
                    <form id="zdyjForm" method="post">
                        <textarea id="medicalResult" name="medicalResult"></textarea>
                    </form>
                    <div id="submitInquiryResult" class="tj">发送</div>
                </div>
            </div>
            ...
            <div class="right">
                ...
                <div id="doctor" >
                    <p><span class="b">姓名：</span><span id="realName">${doctor.realName }</span></p>
                    <p style="line-height:30px;"><span class="b">科室：</span><span id="department">${doctor.department}</span></p>
                    <p style="line-height:30px;"><span class="b">职称：</span><span id="professor">${doctor.professor}</span></p>
                    <p><span class="b">简介：</span><span id="remark">${doctor.remark }</span></p>
                </div>
            </div>
        </div>
    </div>
...
window.pageConfig = {
    doctor: {
        ...
        cameraCfg: {
            camera_no: "${doctorCameraCfg.camera_no}",
      lanip: "${doctorCameraCfg.lanip}",
            port: "${doctorCameraCfg.port}",
            username: "${doctorCameraCfg.username}",
            password: "${doctorCameraCfg.password}",
            deviceSerial: "${doctorCameraCfg.deviceSerial}",
            validateCode:  "${doctorCameraCfg.validateCode}"
        }
    }
};
</script>
...
<script src="${modulePath}health/chat/doctorVersion.js?v=3.7"></script>
