...
<body class="easyui-layout">
    ...
    <div data-options="title:'选择题选项', region:'south',split:true,collapsible:true,collapsed:true" style="height:40%">
        <%@ include file="../questionOption/optionDatagrid.jsp" %>
    </div>
...
<script src="${modulePath}health/house/eval/questionOption/formatters.js"></script>
<script src="${modulePath}health/house/eval/questionOption/questionOption.js"></script>
<script src="${modulePath}health/house/eval/question/question.js"></script>
<script>
